...
<div class="form-group col-md-12">
    ...
    <input type="text" autocomplete="off" class="form-control myinput input-lg" placeholder="Select Deadline"
        v-model="form.deadline" id="datetimepicker4" />
</div>
